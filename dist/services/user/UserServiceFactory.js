...
var UserServiceFactory_exports = {};
__export(UserServiceFactory_exports, {
  UserServiceFactory: () => UserServiceFactory
});
module.exports = __toCommonJS(UserServiceFactory_exports);
...
var UserServiceFactory = class _UserServiceFactory {
  ...
  static build(userRepository) {
    return new _UserServiceFactory(userRepository);
  }
  UserListingService() {
