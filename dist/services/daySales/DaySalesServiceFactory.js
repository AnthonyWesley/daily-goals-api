...
var DaySalesServiceFactory_exports = {};
__export(DaySalesServiceFactory_exports, {
  DaySalesServiceFactory: () => DaySalesServiceFactory
});
module.exports = __toCommonJS(DaySalesServiceFactory_exports);
...
var DaySalesServiceFactory = class _DaySalesServiceFactory {
  ...
  static build(daySalesRepository) {
    return new _DaySalesServiceFactory(daySalesRepository);
  }
